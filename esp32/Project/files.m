classdef files
    ...
    methods(Static)
        function tempFileName = saveTemp(gestureFolder, gestureName, trialNum, acc, gyro)
        ...
        function saveFinal(tempFileName, dataFolder, metadata)
            ...
            if exist(metadataCSV, 'file')
                ...
                idxAcq = 1;
                T = table('Size',[0 5], 'VariableTypes', repmat("string",1,5), ...
                    'VariableNames', {'ID_Subject','Idx_Acquisition','Hand','Available_Sensors','ID_Gesture'});
            end
        ...
        function metadata = handleMetadata(gestureName, trialNum, dataFolder)
            ...
            metadata.Available_Sensors = "MPU6050";  % Default sensors.
        ...
        function savePlots(acc, gyro, time, folder, trialNum, gestureName)
            ...
            try
                ...
                files.plotCombinedData(acc, gyro, time, folder, gestureName, trialNum);
            catch ME
